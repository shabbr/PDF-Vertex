    ...
    <div class="input-form" style="display: block; width: 750px; margin: auto;">
        ...
        <div class="form">
            ...
            {{-- <form action="" class="cite-form" id="form32"> --}}
                ...
                <form action="{{ route('editCitation', ['id' => $citation->id, 'projectId' => $projectId]) }}" method="post">
                    @csrf
                <input type="hidden" name='projectId' value="{{ $projectId }}">
                                        ...
                                        <div class="WEBPAGEAUTHOR">
                                            ...
                                            @if($citation->author!==null)
                                                ...
                                                <div class="inputs">
                                                    ...
                                                    <input type="text" placeholder="First Name" value='{{$citation->author}}' name="firstName" />
                                          @endif
                                          @if($citation->author_last_name!==null)
                                          <input type="text" placeholder="Last Name" value='{{$citation->author_last_name}}' name='lastName' />
                        ...
                        <div class="container mt-5 WEBSITE body" id="body32">
                            <div class="toggle-container">
                                <span class="toggle-button1" data-toggle="collapse" href="#toggleContent6">Edit Citation<span
...
<div class="input-wrappers">
    <div class="input-galary inputs">
        ...
        <input type="text" name="title" value="{{$citation->title}}" />
    </div>
</div>
@endif --}}
...
<div class="input-wrappers">
    <div class="input-galary inputs">
        <div class="textdiv">Editor</div>
        <input type="text" name="editor" value="{{ $citation->editor }}" />
    </div>
</div>
@endif
...
<div class="input-wrappers">
    <div class="input-galary inputs">
        <div class="textdiv">Title</div>
        <input type="text" name="title" value="{{ $citation->title }}" />
    </div>
</div>
@endif

@if ($citation->content_type !== null)
<div class="input-wrappers">
    <div class="input-galary inputs">
        <div class="textdiv">Content Type</div>
        <input type="text" name="content_type" value="{{ $citation->content_type }}" />
    </div>
</div>
@endif

@if ($citation->publish_date !== null)
<div class="input-wrappers">
    <div class="input-galary inputs">
        <div class="textdiv">Publish Date</div>
        <input type="text" name="publish_date" value="{{ $citation->publish_date }}" />
    </div>
</div>
@endif
...
<div class="input-wrappers">
    <div class="input-galary inputs">
        ...
        <input type="text" name="url" value="{{ $citation->url }}" />
    </div>
</div>
@endif
...
<div class="input-wrappers">
    <div class="input-galary inputs">
        ...
        <input type="text" name="container" value="{{ $citation->container }}" />
    </div>
</div>
@endif
...
<div class="input-wrappers">
    <div class="input-galary inputs">
        <div class="textdiv">Volume</div>
        <input type="text" name="volume" value="{{ $citation->volume }}" />
    </div>
</div>
@endif

@if ($citation->medium !== null)
<div class="input-wrappers">
    <div class="input-galary inputs">
        <div class="textdiv">Medium</div>
        <input type="text" name="medium" value="{{ $citation->medium }}" />
    </div>
</div>
@endif
...
<div class="input-wrappers">
    <div class="input-galary inputs">
        ...
        <input type="text" name="number" value="{{ $citation->number }}" />
    </div>
</div>
@endif

@if ($citation->pages !== null)
<div class="input-wrappers">
    <div class="input-galary inputs">
        <div class="textdiv">Pages</div>
        <input type="text" name="pages" value="{{ $citation->pages }}" />
    </div>
</div>
@endif

@if ($citation->booktitle !== null)
<div class="input-wrappers">
    <div class="input-galary inputs">
        <div class="textdiv">Book Title</div>
        <input type="text" name="booktitle" value="{{ $citation->booktitle }}" />
    </div>
</div>
@endif
...
@if ($citation->institution !== null)
<div class="input-wrappers">
    <div class="input-galary inputs">
        <div class="textdiv">Institution</div>
        <input type="text" name="institution" value="{{ $citation->institution }}" />
    </div>
</div>
@endif

@if ($citation->location !== null)
<div class="input-wrappers">
    <div class="input-galary inputs">
        <div class="textdiv">Location</div>
        <input type="text" name="location" value="{{ $citation->location }}" />
    </div>
</div>
@endif

@if ($citation->school !== null)
<div class="input-wrappers">
    <div class="input-galary inputs">
        <div class="textdiv">School</div>
        <input type="text" name="school" value="{{ $citation->school }}" />
    </div>
</div>
@endif

@if ($citation->annotation !== null)
<div class="input-wrappers">
    <div class="input-galary inputs">
        <div class="textdiv">Annotation</div>
        <input type="text" name="annotation" value="{{ $citation->annotation }}" />
    </div>
</div>
@endif
                                    ...
                                    <div class="toggle-content">
                                        ...
                                        <div class="input-wrappers ">
                                            <div class="input-loc inputs">
                                                ...
                                                <textarea name="annotation" rows="3" cols="70" id="text-area">{{$citation->annotation}}</textarea>
                                            </div>
                                        </div>
                                        @endif
                                    </div>
