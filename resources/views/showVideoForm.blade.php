...
<body>
    ...
    <div class="input-form" style="display: block; width: 750px; margin: auto;">
        ...
        <div class="form">
            ...
            <form action="{{ route('submitVideoForm') }}" class="cite-form" id="form32" method="post">
                @csrf
                ...
                <div class="input-wrappers">
                    ...
                    <div class="inputs">
                        ...
                        <input type="hidden" projectId="title" name='projectId' value="{{ $projectId }}" />
                    </div>
                </div>
                    ...
                    @foreach ($results as $result)
                        ...
                        <div class="container mt-5 WEBSITE body" id="body32">
                            <div class="toggle-container">
                                <span class="toggle-button1" data-toggle="collapse" href="#toggleContent6">Website<span
                                    ...
                                    <div class="toggle-content">
                                        ...
                                        <div class="input-wrappers">
                                            <div class="input-galary inputs">
                                                <div class="textdiv">Platform</div>
                                                <input type="text" name="plateform" value="{{ isset($result['plateform']) ? $result['plateform'] : '' }}" />
                                            </div>
                                        </div>
                                        <div class="input-wrappers">
                                            <div class="input-galary inputs">
                                                <div class="textdiv">Title of Article or Page</div>
                                                <input type="text" name="title" value="{{ isset($result['title']) ? $result['title'] : ''  }}" />
                                            </div>
                                        </div>
                                        ...
                                        <div class="input-wrappers">
                                            <div class="input-date inputs">
                                                ...
                                                <input type="date"   name="publishDate"  value="{{  isset($result['publishedYear']) ? $result['publishedYear'] : ''  }}-{{  isset($result['publishedMonth']) ? $result['publishedMonth'] : ''  }}-{{  isset($result['publishedDay']) ? $result['publishedDay'] : '' }}"/>
                                        ...
                                        <div class="input-wrappers">
                                            <div class="input-medium inputs">
                                                ...
                                                <input type="text" name="publisher" value="{{ isset($result['channelTitle']) ? $result['channelTitle'] : ''   }}" />
                                            </div>
                                        </div>
                                        ...
                                        <div class="input-wrappers">
                                            <div class="input-galary inputs">
                                                ...
                                                <input type="text" name="url" value="{{ isset($result['url']) ? $result['url'] : ''  }}" />
                                            </div>
                                        </div>
                                        <div class="input-wrappers">
                                            <div class="input-galary inputs">
