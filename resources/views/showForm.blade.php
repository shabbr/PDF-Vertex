...
<body>
    ...
    <div class="input-form" style="display: block; width: 750px; margin: auto;">
        ...
        <div class="form">
            ...
            <form action="{{ route('submitDetails') }}" class="cite-form" id="form32" method="post">
                @csrf
                        ...
                        <div class="container mt-5 WEBSITE body" id="body32">
                            <div class="toggle-container">
                                ...
                                <div class="collapse show" id="toggleContent6">
                                    <div class="toggle-content">
                                        <?php
                                        $resultDate = $result['pagemap']['metatags'][0]['og:article:published_time'] ??
                                                      ($result['pagemap']['metatags'][0]['article:published_time'] ??
                                                      ($result['pagemap']['metatags'][0]['pubdate'] ?? 'N/A'));

                                                      if ($resultDate !== 'N/A') {
    $dateObject = new DateTime($resultDate);
    $formattedDate = $dateObject->format('Y-m-d');
} else {
    $formattedDate = 'N/A'; // or any other default value or handling you prefer
}
                                    ?>
...
$date = $dateObject->format('Y-m-d');
                                        ...
                                        <div class="input-wrappers">
                                            <div class="input-date inputs">
                                                ...
                                                <input type="date"   name="publishDate"  value="{{ $formattedDate }}"/>
                                            </div>
                                        </div>
                                        <div class="input-wrappers">
                                            <div class="input-medium inputs">
                                                <div class="textdiv">Publisher</div>
                                                <input type="text" name="publisher" value="{{ $result['pagemap']['metatags'][0]['og:site_name'] ?? ($result['pagemap']['cse_image'][0]['og:site_name'] ) }}" />
                                            </div>
                                        </div>
                                        ...
                                        <div class="input-wrappers">
                                            <div class="input-galary inputs">
                                                ...
                                                <input type="text" name="url" value="{{ $result['link'] }}" />
                                            </div>
                                        </div>
                                        <div class="input-wrappers">
                                            <div class="input-galary inputs">
