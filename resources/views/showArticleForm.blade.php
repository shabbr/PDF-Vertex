...
.responses .response:hover .response-icons,.responses .response:hover div input{
    opacity: 1;
}
...
.contact-dialog .dialog-body .body1 div img,.contact-dialog .dialog-body .body1 div svg{
    width: 45px;
    height: 45px;
    padding: 10px;
}
...
.dialog-body-2 form div input, .dialog-body-2 form div textarea{
    width: 300px;
    padding: 6px;
...
.dialog-body-2 form div input:focus, .dialog-body-2 form div textarea:focus{
...
<body>
    ...
    <div class="input-form" style="display: block; width: 750px; margin: auto;">
      ...
      <!-- journal article form28 -->
      <form action="{{route('submitArticleForm')}}" method="post" class="cite-form" id="form28">
        @csrf
              ...
              <div class="toggle-content">
                <div class="input-wrappers">
                  <div class="input-title inputs">
                    ...
                    <input type="text" name='title' value="{{$articleTitle}}" />
                  </div>
                </div>
                <div class="input-wrappers">
                  <div class="input-date inputs">
                    <div class="textdiv">DATE PUBLISHED:</div>
                    <input type="date" name='publishedDate'  value="{{$publishedDate}}" />
                  </div>
                </div>
                <div class="input-wrappers">
                  <div class="input-medium inputs">
                    <div class="textdiv">PAGE RANGE</div>
                    <input type="text"  name='pageRange' value="{{$pageRange}}" />
                  </div>
                </div>
                <div class="input-wrappers">
