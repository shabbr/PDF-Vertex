...
<body>
    <!-- user- dialog -->
    {{-- <dialog class="user-dialog" open="false"> --}}
      {{-- <div>
    ...
    {{-- </dialog> --}}
    <!-- notification dialog -->
    {{-- <dialog class="notifi-dialog" >
        <div class="notifi-head">
            <h1 class="fst-normal fs-4">What's new on MyBib</h1>
            <button class="close-notifi"><img src="./images/close.png" alt="close" width="15"></button>
        </div>
        <div class="notifi-content">
            ...
            <div class="notification">
                ...
                <div class="feature">
                  <p>NEW FEATURES</p> <span>{{ $notification->created_at->format('Y-m-d') }}</span></div>
                <div class="data">
    ...
    <div class=" language" style="margin-bottom:7%; margin-right:2%;">
        <div class="popup-container">
            <div class="lang-popup-container">
                <a href="#" id="user-account-lang"><img src="images/en-US.svg" class="filtericon-lang" alt="User Account"></a>
    ...
    <!--  dialog of email contact -->
            <dialog  id="contact-dialog" class="contact-dialog" >
                <div class="dialog-head">
                    ...
                    <button class="close-support dialog-cross"><img src="./images/close.png" alt="close" width="15"></button>
                </div>
                <hr>
                <div class="dialog-body"  >
                    ...
                    <hr>
                <button class="btn btn-light close-support">Close</button>
                </div>
                <div class="dialog-body-1" >
                    <p style="text-align: left;">
                       ...
                       <span>👍 Yes, I did. </span> <br><br>
                        ...
                        Great! You can recover your work by logging back into your account here: <span><button  class="border btn btn-light"><a href="./login.html"  class="text-decoration-none text-secondary">Login</a></button></span>  <br><br>
                       ...
                       <span> 👎 No, I did not.</span> <br><br>
                        ...
                        <span><button class="border btn btn-light"><a href="./signIn.html" class="text-decoration-none text-secondary">Sign up</a></button></span>
                    </p>
                    <hr>
                <button class="btn btn-light close-support">Close</button>
                </div>
                <div class="dialog-body-2">
                    ...
                    <form class="" action="{{ route('contactMail') }}" method="POST">
                        @csrf
                        <div><label for="To">To</label><input type="email" name="" id=""
                                value="MyBib Support <support@mybib.com>" readonly></div>
                        <div><label for="user-email">FROM (YOUR EMAIL)</label> <input type="email" name="sendFrom"
                                id="user-email" placeholder="Enter your email address">
                                @error('sendFrom')
                    ...
                    <hr>
                    <div><button class="btn btn-light close-support">Cancel</button> <button type='submit' class="btn btn-light send">Send</button></div>
                </div>
            </form>
            </dialog>
        <!--  share dialog here -->
        <dialog class="share-dialog" id="share-dialog"  style="z-index: 1000;">
            <div class="share-head">
                <h1>Sharing settings</h1>
                <button class="close-share-model dialog-cross"><img src="./images/close.png" alt="close" width="15"></button>
            </div>
            <div class="share-body">
                <hr>
                <div class="d-flex">
                    @lang('lang.sharing')<span><div class="form-check form-switch ms-2">
                        <input class="form-check-input switch-btn" type="checkbox" role="switch" id="flexSwitchCheckDefault">
                ...
                <div >
                    ...
                    <button type="button" class="my-1 border btn btn-light share-email-btn">
    ...
    <nav class="navbar">
        ...
        <div class="logo-head">
            ...
            <ul class="dropdown-menu" style="width: max-content; padding: 14px 0;">
                <li><a class="dropdown-item" href="#">AI proof Reader</a></li>
         ...
         <div class="sidebar-bottom">
            <!-- msg -->
            <svg version="1.1" id="Layer_1" class="msg" xmlns="http://www.w3.org/2000/svg"
        ...
        <div class="vertical-icons">
            <div class="popup-container">
                <a href="#" id="user-account"><img src="images/user-account.png" class="filtericon" alt="User Account"></a>
        ...
        <div class="sidebar">
            ...
            <div class="sidebar-center">
                <div class="start-project">
                    ...
                    <input type="submit" value="@lang('lang.newProject')">
                </form>
                @else
                <svg xmlns="http://www.w3.org/2000/svg" shape-rendering="geometricPrecision"
                        text-rendering="geometricPrecision" image-rendering="optimizeQuality" fill-rule="evenodd"
                ...
                <button class="generateCitationBtn">@lang('lang.newProject')</button>
                @endauth
                </div>
...
<div class="delete-and-archive">
    ...
    <div>
        <a href="{{ route('deletedProjects') }}" class='link'> <svg viewBox="0 0 24 24"
                xmlns="http://www.w3.org/2000/svg">
...
@endauth
                ...
                {{-- <div class="delete-and-archive">
                     @auth
                        <a href="{{ route('showArchieveProject') }}"class='link'>

                    <div id="archiveBtn"> <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
               <g id="SVGRepo_bgCarrier" stroke-width="0" />
                    ...
                    @else
                    <div id="archiveBtn" class='generateCitationBtn'> <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                        <g id="SVGRepo_bgCarrier" stroke-width="0" />
...
{{--
                    @else
                        <div id="deleteBtn" class='generateCitationBtn'>
            ...
            @foreach ($projects as $project)
                <div class="mt-2 new-project">
                    <form class="rename-form" data-project-id="{{ $project->id }}">
                        ...
                        <a href="#" class="" id='optionsDropdown'><img src="images/threedots_icon.png" alt=""></a>
            ...
            <div class="main-main">
                <div class="main-center">
                    <div class="main-head">
                        <div>
                            @auth
                            <button class="add-citation btn btn-success open-citation">
                                <img src="images/plus-line-icon.svg" alt="">
                                 @lang('lang.add')
                            </button>
                                @else
                            <button class="generateCitationBtn add-citation btn btn-success">  @lang('lang.add')</button>
                            @endauth
                            @auth
                        ...
                        <select class="form-select select-style" aria-label="Default select example">
                            <option selected>ACM Transactions on Applied Perception</option>
                ...
                @endauth
                    ...
                    <div class="main-page">
                        <div class="page-head">
                            ...
                            <dialog id="styles-dialog">
                                <img src="images/close.png" class="close-styles-modal" alt="">
                                ...
                                <button class="btn btn-styles-cancel btn-close-styles">Cancel</button>

                                <button class="btn btn-primary btn-styles-save btn-close-styles" id="style_submit">Save Changes</button>
                        ...
                        <div class="form-check">
                            ...
                            {{-- <form action="{{route('searchGoogleScholar')}}" method='post' class='btn btn-success'>
                                @csrf
                            <input type='text' value='' name='article'>
                            <input type='hidden' value='{{$projectId}}' name='projectId'>

                            <input type='submit' value='submit'>
                            </form> --}}
                            {{-- <a href='{{route('forms')}}' class='btn btn-primary'>show forms</a> --}}
                        </div>
                        ...
                        <div id="responseContainer" class="showresponseContainer" >
                            ...
                            @foreach ($citations as $citation)
                                    <div class="response" >
                                        ...
                                        <div style="padding: 0px 1in 0px calc(100px); text-indent: -36pt ; ">
                                                      {{ isset($citation->author) ? $citation->author . ',' : '' }}
                                                      {{ isset($citation->author_last_name) ? $citation->author_last_name . ',' : '' }}
                                            {{ isset($citation->editor) ? $citation->editor . ',' : '' }}
                                            {{ isset($citation->title) ? $citation->title . ',' : '' }}
                                             {{ isset($citation->content_page) ? $citation->content_page . ',' : '' }}
                                            {{ isset($citation->publish_date) ? $citation->publish_date . ',' : '' }}
                                             {{ isset($citation->url) ? $citation->url . ',' : '' }}
                                             {{ isset($citation->container) ? $citation->container . ',' : '' }}
                                            {{ isset($citation->view_date) ? $citation->view_date . '.' : '' }}

                                            {{ isset($citation->interviewer_first_name) ? $citation->interviewer_first_name . ',' : '' }}
                                            {{ isset($citation->interviewer_last_name) ? $citation->interviewer_last_name . ',' : '' }}
                                            {{ isset($citation->content_type) ? $citation->content_type . ',' : '' }}
                                            {{ isset($citation->volume) ? $citation->volume . ',' : '' }}
                                            {{ isset($citation->number) ? $citation->number . ',' : '' }}
                                            {{ isset($citation->pages) ? $citation->pages . ',' : '' }}
                                            {{ isset($citation->booktitle) ? $citation->booktitle . ',' : '' }}
                                            {{ isset($citation->publisher) ? $citation->publisher . ',' : '' }}
                                            {{ isset($citation->institution) ? $citation->institution . ',' : '' }}
                                            {{ isset($citation->location) ? $citation->location . ',' : '' }}
                                            {{ isset($citation->school) ? $citation->school . ',' : '' }}
                                            {{ isset($citation->annotation) ? $citation->annotation . '.' : '' }}
            ...
            <div id="hideData" style=" ">
                          ...
                          <span style="    font-weight: bold;
                            ...
                            <p>There are no citations in this project yet.
                             ...
                             @auth
                            <button class="add-citation btn btn-success open-citation-modal">
                            <img src="images/plus-line-icon.svg" alt="">
                            @lang('lang.add')
                        </button>
                        @else
                        ...
                        @endauth
                            ...
                            <dialog id="citation-modal">
                                <img src="images/close.png" class="close-modal" alt="">
                                ...
                                <hr class="w-100 ">
                                             ...
                                             <br>
                                              <a style="text-decoration: none; border: 1px solid gray; padding:10px;     display: flex;
                                                ...
                                                justify-content: center;
                                                width: max-content;
                                                margin: auto;" href="#" onclick="urlToForm({headTittle:'Book' , option:27})" class="btn btn-outline btn-inline"><i class="bi bi-keyboard me-2 fs-4"></i>enter manually</a>
                                          </div>
                                          <div class="v-portal" style="display: none;"></div>
                                      </div>
                                      </div>
                                  ...
                                  <div class="searchDataCite">
                                    <div>
                                      <ul style="margin-bottom: 50px; font-size: 10px;" >
                                          <li style="list-style-type: none;" class="urlConfirm" onclick="urlToForm({headTittle:'Journal Article' , option:28})">
                                              <button class="w-full p-0" style="border:none;" fdprocessedid="swlrxm">
                                                  <div class="flex w-full px-5 py-4 text-left hover:bg-ui-bg" style="display: flex; text-align: left; align-items: center;">
                                                      <img width="50px" height="auto" src="https://favicons.mybib.com/icon?url=https://www.google.com&amp;size=60..120..200" title="Website" referrerpolicy="no-referrer" class="items-center bg-white rounded-md text-white flex shrink-0 h-[60px] justify-center mr-5 mt-1 w-[60px] shadow-[0_1px_2px_rgba(0,0,0,0.2)] object-cover">
...
<div class="text-base font-medium" id='ajaxResponseArticle' >
      <span></span>
                                ...
                                <hr class="w-100 ">
                                         ...
                                         <br>
                                          <a style="text-decoration: none; border: 1px solid gray; padding:10px;     display: flex;
                                                ...
                                                justify-content: center;
                                                width: max-content;
                                                margin: auto;" href="#" onclick="urlToForm({headTittle:'Journal Article' , option:28})" class="btn btn-outline btn-inline"><i class="bi bi-keyboard me-2 fs-4"></i>enter manually</a>
                                      </div>
                                      <div class="v-portal" style="display: none;"></div>
                                  </div>
                                  </div>
                              ...
                              <div class="tab-pane fade" id="nav-video" role="tabpanel"
                                  ...
                                  <div class="p-4 bar">
                                      <input type="text" class="input"  id="inputValue4"
                                          placeholder="Search for the video title or paste the URL"  id="inputValue4" >
                                  ...
                                  <div class="searchDataCite">
                                    <div>
                                      <ul style="margin-bottom: 50px; font-size: 10px;" >
                                          <li style="list-style-type: none;" class="urlConfirm" onclick="urlToForm({headTittle:'Video' , option:31})" >
                                              <button class="w-full p-0" style="border:none;" fdprocessedid="swlrxm">
                                                  <div class="flex w-full px-5 py-4 text-left hover:bg-ui-bg" style="display: flex; text-align: left; align-items: center;">
                                                      <img width="50px" height="auto" src="https://favicons.mybib.com/icon?url=https://www.google.com&amp;size=60..120..200" title="Website" referrerpolicy="no-referrer" class="items-center bg-white rounded-md text-white flex shrink-0 h-[60px] justify-center mr-5 mt-1 w-[60px] shadow-[0_1px_2px_rgba(0,0,0,0.2)] object-cover">
                                                      <div style="flex: 1 1 0%; padding-left: 20px; display: flex; flex-direction: column; justify-content: space-between;">
                                ...
                                <hr class="w-100 ">
                                         ...
                                         <br>
                                          <a style="text-decoration: none; border: 1px solid gray; padding:10px;     display: flex;
                                                ...
                                                justify-content: center;
                                                width: max-content;
                                                margin: auto;" href="#" onclick="urlToForm({headTittle:'Video' , option:31})" class="btn btn-outline btn-inline"><i class="bi bi-keyboard me-2 fs-4"></i>enter manually</a>
                                      </div>
                                      <div class="v-portal" style="display: none;"></div>
                                  </div>
                                  </div>
                                  ...
                                  <div class="tab-pane fade" id="nav-more" role="tabpanel"
                                      ...
                                      <div class="p-2 bar bar-options"  id="options">
                                          ...
                                          <div class="options" data-option="33" >
                                              write/past citation
                                          </div>
                                    ...
                                    <div class="form">
                                        ...
                                        <form action="{{route('artist')}}" method='post'  class="cite-form" id="form1">
                                            ...
                                            <div class="container mt-5 Contributers header" id="header1">
                                                <div class="toggle-container">
                                                    <span class="toggle-button" data-toggle="collapse"
                                                        href="#toggleContent1">contribution<span class="line"></span><span
                                                            class="arrow">&#x2039;</span></span>
                                                    <div class="collapse show" id="toggleContent1">
                                                        <div class="toggle-content">
                                                            <div class="artist" style="display: flex; justify-content: center; align-items: center; text-align: right;">
                                                               <span> Artist:</span>

                                                                &nbsp;&nbsp;
                                                                <div  class="d-flex"><input
                                                                    type="text" placeholder="First Name" name="firstName"><br>
                                                                    <input type="text"
                                            ...
                                            <div class="container mt-5 annotation footer"  id="globalFooter">
                                                                                ...
                                                                                <button style="border-radius: 12px;"  id="btnform" type="submit" class="flex btn btn-primary save-citation-form"><span style="font-size: 20px;">&#10003;&nbsp;</span>Save</button></div>
                                        </form>
                                        <!-- form 1-->
...
<div class="container mt-5 annotation footer"  id="globalFooter">
                ...
                <div class="container mt-5 PAPERAUTHOR header" id="header12">
                                        ...
                                        <form action="{{route('artist')}}" method='post' class="cite-form" id="form15">
                                          @csrf
                                          <input type="hidden" name="projectId" value="{{ $projectId }}">
                                        ...
                                        <!-- form 19 -->
                                        <form action="{{route('Ebook')}}" method='post' class="cite-form" id="form20">
                                          @csrf
                                          <input type="hidden" name="projectId" value="{{ $projectId }}">
                                        ...
                                        <!-- form 20 -->
                                        <form action="{{route('NewsArticle')}}" method='post' class="cite-form" id="form14">
                                          @csrf
                                          <input type="hidden" name="projectId" value="{{ $projectId }}">
                                          <div class="container mt-5 ARTICLEAUTHOR header" id="header14">
                                            <div class="toggle-container">
                                                  ...
                                                  <div class="ENTRYAUTHOR">
                                                    <div class="input-wrappers">
                                                      ...
                                                      <div class="inputs">
                                                        <input type="text" placeholder="First Name" name="firstName" /><input
                                                          type="text"
                                                          placeholder="Last Name" name="lasttName"
                                                        />
                                                        <div class="d-flex">
                                                          <button>
                                                            <img
                                        ...
                                        <!-- form 26 -->
                                        <form action="{{route('MagzineArticle')}}" method='post' class="cite-form" id="form14">
                                          @csrf
                                          <input type="hidden" name="projectId" value="{{ $projectId }}">
                                          <div class="container mt-5 ARTICLEAUTHOR header" id="header14">
                                            <div class="toggle-container">
                                              ...
                                              <div class="collapse show" id="toggleContent2">
                                                <div class="toggle-content">
                                                  ...
                                                  <div class="input-wrappers">
                                                    <div class="input-date inputs">
                                                      <div class="textdiv">DATE PUBLISHED:</div>
                                                      <input type="date"  name="piblishedDate"/>
                                                    </div>
                                                  </div>
                                                  <div class="input-wrappers">
                                                    <div class="input-medium inputs">
                                        ...
                                        <!-- from 30 -->
                                        <form action="{{route('Website')}}" method='post' class="cite-form" id="form31">
                                          @csrf
                                          <input type="hidden" name="projectId" value="{{ $projectId }}">
                                        ...
                                        <!-- from 31 -->
                                        <form action="{{route('Citation')}}" method='post'  class="cite-form" id="form32">
                                          @csrf
                                          <input type="hidden" name="projectId" value="{{ $projectId }}">
                                        ...
                                        {{-- <form action="" class="cite-form" id="form14">
                                          <div class="container mt-5 ARTICLEAUTHOR header" id="header14">
                                            <div class="toggle-container">
                                              <span class="toggle-button" data-toggle="collapse" href="#toggleContent2"
                                                >Contribution<span class="line"></span
    ...
    <div>
       <div  class="btns">PREVIEW</div>
        <div id="preview1" style="float: left; margin-left: 150px;"></div>
                                        ...
                                        <form action="" class="cite-form" id="form15">
                                          <div class="container mt-5 ARTICLEAUTHOR header" id="header15">
                                            <div class="toggle-container">
                                              <span class="toggle-button" data-toggle="collapse" href="#toggleContent2"
                                                >Contribution<span class="line"></span
    ...
    <div>
       <div  class="btns">PREVIEW</div>
        <div id="preview1" style="float: left; margin-left: 150px;"></div>
                                        ...
                                        <form action="" class="cite-form" id="form16">
                                          <div class="container mt-5 AUTHOR header" id="header16">
                                            <div class="toggle-container">
                                              <span class="toggle-button" data-toggle="collapse" href="#toggleContent2"
                                                >Contribution<span class="line"></span
    ...
    <div>
       <div  class="btns">PREVIEW</div>
        <div id="preview1" style="float: left; margin-left: 150px;"></div>
                                        ...
                                        <form action="" class="cite-form" id="form17">
                                          <div class="container mt-5 ENTRYAUTHOR header" id="header17">
                                            <div class="toggle-container">
                                              <span class="toggle-button" data-toggle="collapse" href="#toggleContent2"
                                                >Contribution<span class="line"></span
    ...
    <div>
       <div  class="btns">PREVIEW</div>
        <div id="preview1" style="float: left; margin-left: 150px;"></div>
                                        ...
                                        <!-- form 17 -->
                                        <form action="" class="cite-form" id="form18">
                                          <div class="container mt-5 MAPAUTHOR header" id="header18">
                                            <div class="toggle-container">
                                              <span class="toggle-button" data-toggle="collapse" href="#toggleContent2"
                                                >Contribution<span class="line"></span
    ...
    <div>
       <div  class="btns">PREVIEW</div>
        <div id="preview1" style="float: left; margin-left: 150px;"></div>
                                        ...
                                        <!-- form 18 -->
                                        <form action="" class="cite-form" id="form19">
                                          <div class="container mt-5 DIRECTORORPRESENTER header" id="header19">
                                            <div class="toggle-container">
                                              <span class="toggle-button" data-toggle="collapse" href="#toggleContent2"
                                                >Contribution<span class="line"></span
    ...
    <div>
       <div  class="btns">PREVIEW</div>
        <div id="preview1" style="float: left; margin-left: 150px;"></div>
                                        ...
                                        <!-- form 19 -->
                                        <form action="" class="cite-form" id="form20">
                                          <div class="container mt-5 AUTHOR header" id="header20">
                                            <div class="toggle-container">
                                              <span class="toggle-button" data-toggle="collapse" href="#toggleContent2"
                                                >Contribution<span class="line"></span
    ...
    <div>
       <div  class="btns">PREVIEW</div>
        <div id="preview1" style="float: left; margin-left: 150px;"></div>
                                        ...
                                        <!-- form 20 -->
                                        <form action="" class="cite-form" id="form21">
    ...
    <div>
       <div  class="btns">PREVIEW</div>
        <div id="preview1" style="float: left; margin-left: 150px;"></div>
                                        ...
                                        <form action="" class="cite-form" id="form22">
                                          <div class="container mt-5 ENTRYAUTHOR header" id="header22">
                                            <div class="toggle-container">
                                              <span class="toggle-button" data-toggle="collapse" href="#toggleContent2"
                                                >Contribution<span class="line"></span
    ...
    <div>
       <div  class="btns">PREVIEW</div>
        <div id="preview1" style="float: left; margin-left: 150px;"></div>
                                        ...
                                        <form action="" class="cite-form" id="form23">
                                          <div class="container mt-5 INVENTOR header" id="header23">
                                            <div class="toggle-container">
                                              <span class="toggle-button" data-toggle="collapse" href="#toggleContent2"
                                                >Contribution<span class="line"></span
    ...
    <div>
       <div  class="btns">PREVIEW</div>
        <div id="preview1" style="float: left; margin-left: 150px;"></div>
                                        ...
                                        <form action="" class="cite-form" id="form24">
                                          <div class="container mt-5 DIRECTORORPRESENTER header" id="header24">
                                            <div class="toggle-container">
                                              <span class="toggle-button" data-toggle="collapse" href="#toggleContent2"
                                                >Contribution<span class="line"></span
    ...
    <div>
       <div  class="btns">PREVIEW</div>
        <div id="preview1" style="float: left; margin-left: 150px;"></div>
                                        ...
                                        <form action="" class="cite-form" id="form25">
                                          <div class="container mt-5 COMMUNICATION header" id="header26">
                                            <div class="toggle-container">
                                              <span class="toggle-button" data-toggle="collapse" href="#toggleContent2"
                                                >Contribution<span class="line"></span
    ...
    <div>
       <div  class="btns">PREVIEW</div>
        <div id="preview1" style="float: left; margin-left: 150px;"></div>
                                        ...
                                        <form action="" class="cite-form" id="form26">
                                          <div class="container mt-5 BOOKAUTHOR header" id="header27">
                                            <div class="toggle-container">
                                              <span class="toggle-button" data-toggle="collapse" href="#toggleContent2"
                                                >Contribution<span class="line"></span
    ...
    <div>
       <div  class="btns">PREVIEW</div>
        <div id="preview1" style="float: left; margin-left: 150px;"></div>
                                        ...
                                        <!-- form 26 -->
                                        <form action="" class="cite-form" id="form27">
    ...
    <div>
       <div  class="btns">PREVIEW</div>
        <div id="preview1" style="float: left; margin-left: 150px;"></div>
                                        ...
                                        <!-- from 27 -->
                                        <form action="" class="cite-form" id="form28">
                                          <div class="container mt-5 REVIEWAUTHOR header" id="header29">
                                            <div class="toggle-container">
                                              <span class="toggle-button" data-toggle="collapse" href="#toggleContent2"
                                                >Contribution<span class="line"></span
    ...
    <div>
       <div  class="btns">PREVIEW</div>
        <div id="preview1" style="float: left; margin-left: 150px;"></div>
                                        ...
                                        <!-- from 28 -->
                                        <form action="" class="cite-form" id="form29">
                                          <div class="container mt-5 AUTHOR header" id="header30">
                                            <div class="toggle-container">
                                              <span class="toggle-button" data-toggle="collapse" href="#toggleContent2"
                                                >Contribution<span class="line"></span
    ...
    <div>
       <div  class="btns">PREVIEW</div>
        <div id="preview1" style="float: left; margin-left: 150px;"></div>
                                        ...
                                        <!-- from 29 -->
                                        <form action="" class="cite-form" id="form30">
                                          <div class="container mt-5 VIDEOAUTHOR header" id="header31">
                                            <div class="toggle-container">
                                              <span class="toggle-button" data-toggle="collapse" href="#toggleContent2"
                                                >Contribution<span class="line"></span
                                            ...
                                            <div class="toggle-container">
                                              ...
                                              <div class="collapse show" id="toggleContent6">
                                                <div class="toggle-content">
                                                  ...
                                                  <div class="input-wrappers">
                                                    <div class="input-galary inputs">
                                                      <div class="textdiv">Published Date</div>
                                                      <input type="date" />
                                                    </div>
                                                  </div>
                                                  <div class="input-wrappers">
    ...
    <div>
       <div  class="btns">PREVIEW</div>
        <div id="preview1" style="float: left; margin-left: 150px;"></div>
                                        ...
                                        <!-- from 31 -->
                                        <form action="" class="cite-form" id="form31">
                                          <div class="container mt-5 CITATION body" id="body33">
                                            <div class="toggle-container">
                                              <span class="toggle-button1" data-toggle="collapse" href="#toggleContent9"
                                                >Citation<span class="line"></span
...
//     optionsDropdown.addEventListener("blur", function(event) {
//     // Hide the dropdown menu
//     dropdownMenu.style.display = "none";
// });

    // Add event listeners for each option
    var renameOption = document.getElementById("renameOption");
    var mergeOption = document.getElementById("mergeOption");
    var duplicateOption = document.getElementById("duplicateOption");
    ...
    function handleOptionClick(event) {
        event.preventDefault();
        // Implement the action for each option here
    ...
    renameOption.addEventListener("click", handleOptionClick);
    duplicateOption.addEventListener("click", handleOptionClick);
    mergeOption.addEventListener("click", handleOptionClick);
    addToFolderOption.addEventListener("click", handleOptionClick);
    colorOption.addEventListener("click", handleOptionClick);
    archiveOption.addEventListener("click", handleOptionClick);
    deleteOption.addEventListener("click", handleOptionClick);
});
